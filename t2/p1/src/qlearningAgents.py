...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        qValues = map(lambda a : self.getQValue(state, a), legalActions)
    ...
    def update(self, state, action, nextState, reward):
        ...
        bestExpectedQValue = reward + self.discount * self.computeValueFromQValues(nextState)
        newQValue = (1 - self.alpha) * oldQValue + self.alpha * bestExpectedQValue
